...
const Gallery = () => {
  ...
  const images = {
    shoes: [
      ...
      { id: 9, src: 'https://synxalrnnjegqzaxydis.supabase.co/storage/v1/object/sign/KamaCleans/images/gallery/shoes/9.webp?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJLYW1hQ2xlYW5zL2ltYWdlcy9nYWxsZXJ5L3Nob2VzLzkud2VicCIsImlhdCI6MTczOTUzODM3OCwiZXhwIjoxNzcxMDc0Mzc4fQ.0XwGENYQVkOUmVeFKSYZ_92FKxhtbfvjVcxcTDUsKow', category: 'shoes' },
